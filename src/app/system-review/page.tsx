...
export default function SystemReviewPage() {
  ...
  const reviews = [
    {
      title: t('review.ownerPanel'),
      desc: t('review.ownerPanelDesc'),
      image: '/previews/dashboard_preview_1.png',
      badge: 'Super Admin',
      icon: Shield,
    },
    {
      title: t('review.bizPanel'),
      desc: t('review.bizPanelDesc'),
      image: '/previews/dashboard_preview_2.png',
      badge: 'Business Tenant',
      icon: Layout,
    },
    {
      title: t('review.managerPanel'),
      desc: t('review.managerPanelDesc'),
      image: '/previews/dashboard_preview_3.png',
